...
users = [
  ...
  {:username => "Destorina Ridla Nurwahibah", :keyid => "111128384", :password => "tes123456", :faculty_id => 2},
  {:username => "Adly Gilang Kurnia", :keyid => "111128371", :password => "tes123456", :faculty_id => 2},
  ...
  {:username => "Al Bukhari Pahlevi", :keyid => "111128369", :password => "tes123456", :faculty_id => 2},
  {:username => "Efany Danarti", :keyid => "111128364", :password => "tes123456", :faculty_id => 2},
  {:username => "Tina Widi Pangesti", :keyid => "111128387", :password => "tes123456", :faculty_id => 2},
  {:username => "Nira Pebriani", :keyid => "111128382", :password => "tes123456", :faculty_id => 2},
  {:username => "Ichwan Nul Ichsan", :keyid => "1111070087", :password => "tes123456", :faculty_id => 2},
  {:username => "Iana Yulianto", :keyid => "114090043", :password => "tes123456", :faculty_id => 3},
